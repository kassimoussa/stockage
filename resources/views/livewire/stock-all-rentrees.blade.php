<div class="py-4 px-3 ">
    ...
    <div class="d-flex justify-content-between  mb-4">
        <h3 class="over-title mb-2">Rentrées des materiels du site {{ $site }}<span class="text-bold" id="title"> </span>
        </h3>
    ...
    <div class="card ">
        ...
        <div class="card-body">
            <div class="tab-content my-2">
                <x-month-table :moisc="$mois" moisl="janvier" :results="$results[1]" type="rentree" i="01"/>
            </div>
            <div class="tab-content my-2">
                <x-month-table :moisc="$mois" moisl="février" :results="$results[2]" type="rentree" i="02"/>
            </div>
            <div class="tab-content my-2">
                <x-month-table :moisc="$mois" moisl="mars" :results="$results[3]" type="rentree" i="03"/>
            </div>
            <div class="tab-content my-2">
                <x-month-table :moisc="$mois" moisl="avril" :results="$results[4]" type="rentree" i="04"/>
            </div>
            <div class="tab-content my-2">
                <x-month-table :moisc="$mois" moisl="mai" :results="$results[5]" type="rentree" i="0"/>
            </div>
            <div class="tab-content my-2">
                <x-month-table :moisc="$mois" moisl="juin" :results="$results[6]" type="rentree" i="06"/>
            </div>
            <div class="tab-content my-2">
                <x-month-table :moisc="$mois" moisl="juillet" :results="$results[7]" type="rentree" i="07"/>
            </div>
            <div class="tab-content my-2">
                <x-month-table :moisc="$mois" moisl="aôut" :results="$results[8]" type="rentree" i="08"/>
            </div>
            <div class="tab-content my-2">
                <x-month-table :moisc="$mois" moisl="septembre" :results="$results[6]" type="rentree" i="09"/>
            </div>
            <div class="tab-content my-2">
                <x-month-table :moisc="$mois" moisl="octobre" :results="$results[10]" type="rentree" i="10"/>
            </div>
            <div class="tab-content my-2">
                <x-month-table :moisc="$mois" moisl="novembre" :results="$results[1]" type="rentree" i="11"/>
            </div>
            <div class="tab-content my-2">
                <x-month-table :moisc="$mois" moisl="décembre" :results="$results[12]" type="rentree" i="12"/>
            </div>
        </div>
    </div>
