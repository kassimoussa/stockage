<div class="py-4 px-3 ">
    <x-loading-indicator />
    <form  wire:submit.prevent="newRentree" class="form">
        <div class="card col-md-12 mb-3">
            <h4 class="card-header text-center">Nouvelle Rentrée</h4>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="row col">
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-3 ">
                                ...
                                <input type="text" class="form-control" wire:model="fournisseur"
                                    placeholder="Fournisseur du materiel" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-3 mb-3">
                                ...
                                <input type="date" class="form-control" wire:model="date_rentree" required>
                            </div>
                        </div>
                ...
                @if ($rentrees->isNotEmpty())
                    ...
                    @foreach ($rentrees as $key => $rentree)
                        <tr>
                            ...
                            <td>{{ ucfirst($rentree->fournisseur) }}</td>
                            <td>{{ $rentree->submitedby }}</td>
