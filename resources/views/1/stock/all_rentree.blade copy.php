                ...
                <ul class="nav nav-tabs nav-justified card-header-tabs" id="rentrees" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-bold @if (date('m') == '05') {{ 'active' }} @endif"
                            ...
                            data-bs-placement="top" title="Total = {{ $rentres[5] }}">Mai</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-bold @if (date('m') == '06') {{ 'active' }} @endif"
                            href="#juin" role="tab" aria-controls="juin" aria-selected="false"
                            data-bs-toggle="tooltip" data-bs-placement="top" title="Total = {{ $rentres[6] }}">Juin</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link fw-bold @if (date('m') == '08') {{ 'active' }} @endif"
                            ...
                            data-bs-toggle="tooltip" data-bs-placement="top" title="Total = {{ $rentres[8] }}">Août</a>
                    </li>
                    <li class="nav-item">
